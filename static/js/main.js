...
$('.js-banner-slider').slick({
    infinite: true,
    arrows: true,
    prevArrow: $('.navig-prev'),
    nextArrow: $('.navig-next'),
    slidesToShow: 1,
    slidesToScroll: 1,
    autoplay: true,
    fade: true,
...
$(".form-js1").each(function () {
  ...
  $(this).on("click", ".form-button", function () {
    if ("" == $(a + " .validate").val()) return $(a + " .validate").css({
      ...
      500), !1;
    if ($(a + " .confidencial__checked input").prop("checked")) $(a).closest(".form-js1").hide(), $(a).closest(".form-js1").siblings(".form-ok").fadeIn(100), setTimeout(function () {
